...
// const getMyTaxes = (country, salary) => parseFloat((country.tax * salary).toFixed(2));
// console.log(getMyTaxes(ukraine, 1000));
...
const getTotalTaxes =  (country) => parseFloat((country.tax * country.middleSalary * country.vacancies).toFixed(2));
console.log(getTotalTaxes(latvia));
...
const getMySalary = (country) =>
  setInterval(() => {
    ...
    const taxes = parseFloat((country.tax * salary).toFixed(2));
